...
#### 1. Google Analytics (GA4) Live Store Performance Dashboard
* Engineered a live cloud data streaming pipeline from the official Google Merchandise Store property into Looker Studio.
* Tracks 83K+ Active Users, 324K+ Total Views, and $168K+ Real-time Revenue.
* 🔗 [Live Interactive Dashboard Link](https://datastudio.google.com/s/jx5B_8UdWa4)
...
* Structured an advanced SQL pipeline to clean, de-duplicate, and standardize a chaotic global layoffs dataset.
* Handled null values, date formatting normalization, and engineered staging tables for absolute data integrity.
* 💻 [View World Layoffs Individual Repository & Code](https://github.com/War-DataSolutions/World_layoffs-Data-Cleaning-SQL)

#### 4. E-Commerce Global Operations & SQL Transaction Model
* Cleaned and transformed 540,000+ transactional data rows using structured SQL queries and cloud database architectures.
* Modeled revenue vectors, country metrics, and customer description profiles.
* 💻 [View E-Commerce Individual Repository & Code](https://github.com/War-DataSolutions/BigQuery-PowerBI-E-Commerce-repository)
